...
var commands = []Command{
	...
	},
	{
		...
		Flags: []Flag{repeatable("persona", "URN", "persona URN the revised story serves; optional", false), epicFlag,
			...
			required("title", "TEXT", "complete revised title"), required("statement", "TEXT", "complete revised statement"), optional("priority", "TEXT", "optional free-text priority; omit it for none"),
			repeatable("criterion", "ID=STATEMENT", "acceptance criterion", false), repeatable("citation", "URN", "citation URN", false),
	...
	},
	{
		...
		Flags: []Flag{epicFlag,
			...
			repeatable("code", "LOCATION", "code location <commit>:<path>[#L<start>[-L<end>]]", false), optional("repo", "PATH", "source checkout when separate"), repeatable("verification", "URN", "verification URN", false), repeatable("citation", "URN", "citation URN", false),
