...
const uiIconSymbols = `` +
	...
	`<symbol id="i-redo" viewBox="0 0 16 16"><path d="M13 8H6.5a3.2 3.2 0 0 0 0 6.4H10M13 8l-3-3M13 8l3 3" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></symbol>` +
