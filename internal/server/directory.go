...
A table can need more width than a phone has, and a mobile browser would widen
the whole page to fit it. The table scrolls sideways inside its own region
instead, so every column stays readable without hiding one. That region is a
