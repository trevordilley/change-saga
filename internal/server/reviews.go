...
.review-item-affordance{gap:2px;padding:3px;background:var(--landmark-affordance-bg)}.review-item-link{min-height:24px;padding:3px 7px;border:1px solid var(--line);border-radius:4px;background:var(--bg);color:var(--accent);font:650 10px var(--ui);box-shadow:0 1px 2px #0002}.review-item-link:hover,.review-item-link:focus-visible{background:var(--accent-soft);border-color:var(--accent)}
