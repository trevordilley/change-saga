...
.deck-viewer-slide .fragment-head [data-review-controls]{opacity:1}
...
body.presentation-mode>.topbar,body.presentation-mode .manifest-view,body.presentation-mode .change-view,body.presentation-mode .annotation-toolbox{display:none}
...
body.presentation-mode .deck-viewer-slide .review-overlay,body.presentation-mode .deck-viewer-slide .landmark-hotspot,body.presentation-mode .deck-viewer-slide .sticky-note,body.presentation-mode .deck-viewer-slide .annotation-bubble{display:none}
