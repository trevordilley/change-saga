...
| [app-saga.md](app-saga.md) | The agreed goals and execution plan for one app Saga: durable epics, personas, code references instead of stored diffs, and opening a Saga to observe or to compare. |
